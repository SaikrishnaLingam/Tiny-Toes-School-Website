        ...
        <div>
            ...
            <div className='md:px-8 lg:px-12 xl:px-24 py-8 flex items-center justify-center flex-col'>
                <div>
                    ...
                    <div className='px-3'>
                        <h1 className='font-bold text-xl lg:text-3xl py-1 md:py-3 lg:py-6'>Playful Learning at TinyToes: </h1>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 justify-center'>
                    ...
                    <div className='px-3'>
                        <h1 className='font-bold text-xl lg:text-3xl py-1 md:py-3 lg:py-6'>Modern Psychological Techniques:</h1>
                    ...
                    <div className='px-3'>
                        <h1 className='font-bold text-xl lg:text-3xl py-1 md:py-3 lg:py-6'>Age-Appropriate Curriculum: </h1>
                    ...
                    <div className='px-3'>
                        <h1 className='font-bold text-xl lg:text-3xl py-1 md:py-3 lg:py-6'>Parental Involvement:</h1>
                ...
                <div className='px-3'>
                    <h1 className='font-bold text-xl lg:text-3xl py-1 md:py-3 lg:py-6'>Our 14-Year Commitment:</h1>
            ...
            <div className='grid grid-cols-2 items-center'>
                <img src={ab6} alt=""/>
                <div className='px-3'>
                    <h1 className='font-bold text-xl lg:text-3xl py-1 md:py-3 lg:py-6'>Parental Engagement: </h1>
